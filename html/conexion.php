...
<?php
    ...
    $usuario = 'root';
    $password = '';
   	$db = new PDO('mysql:host=localhost:3310;dbname=financiera1', $usuario, $password);
    $connect = new mysqli("localhost:3310", "root", "", "financiera1") or die('Error al conectar'. mysqli_error($connect));
