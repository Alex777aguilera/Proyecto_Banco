            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Ver  Tipo Cuenta </h4>
                        <div class="ms-auto text-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="principal.php">Principal</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Tipo Cuenta</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                    ...
                                    echo "<h5 class='card-title'>Basic Datatable</h5>";
                                        echo "<div class='table-responsive'>";
                                            echo "<table id='zero_config' class='table table-striped table-bordered'>";
                                                ...
                                                echo "<td>";
                                                    echo "<a href='update_cuenta.php?id=". $row['idTipoCuenta'] ."' title='' data-toggle='tooltip'><span class='fas fa-pencil-alt'></span></a>";
                                                    echo "<a href='delete_cuenta.php?id=". $row['idTipoCuenta'] ."' title='' data-toggle='tooltip'><span class='fas fa-trash-alt'></span></a>";
                                                echo "</td>";
                                            }
                                            echo "</tbody>";
                                        echo "</table>";
